# Generated by Django 3.2.16 on 2023-03-09 10:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Дайте короткое название группы', max_length=200, verbose_name='Заголовок')),
                ('slug', models.SlugField(help_text='Укажите адрес для страницы группы. Используйте только латиницу, цифры, дефисы и знаки подчёркивания', max_length=200, unique=True, verbose_name='Адресс для страницы с группой')),
